...
while True:
    data, addr = sock.recvfrom(1024)    # data - сообщение от пользователя. addr - адрес пользователя
    if addr not in members:     # Если пользователя нет в списке, то добавлет его туда
